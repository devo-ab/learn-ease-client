      ...
      <div className="w-40 md:w-64 min-h-screen bg-orange-600">
        <ul className="menu p-4">
          {/* {isAdmin ? (
            ...
            <div>
              <li><NavLink to="/dashboard/user-home">Use Home</NavLink></li>
              <li><NavLink to="/dashboard/enroll-classes">My Enroll Classes</NavLink></li>
              <li><NavLink to="/dashboard/profile">Profile</NavLink></li>
              <li></li>
              <li></li>
              <li></li>
          ...
          {
            user && isTeacher && <div><li>Teacher</li></div>
          }
        </ul>
      </div>
